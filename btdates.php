...
<h1 align="center">Library Utilization Report (Datewise)</h1>
<table>
...
{
$sql = "SELECT lib.grn,name,course,intime,outtime,cdate,timediff(outtime,intime) as diff FROM lib,student where cdate between '".$_GET['frmdate']."' and '".$_GET['todate']."' and (student.grn=lib.grn)";

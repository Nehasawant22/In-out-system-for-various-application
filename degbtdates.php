...
<h1 align="center">Degree(B.E.): Library Utilization Report (Datewise)</h1>
<table>
...
{
$sql = "SELECT student.grn,name,intime,outtime,cdate,timediff(outtime,intime) as diff FROM lib,student where cdate between '".$_GET['frmdate']."' and '".$_GET['todate']."' and (course='B.E') and (student.grn=lib.grn)";
